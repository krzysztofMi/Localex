...
--
-- Name: index_users_on_roles_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_users_on_roles_id ON public.users USING btree (roles_id);


--
-- Name: users fk_rails_960e7e39f4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT fk_rails_960e7e39f4 FOREIGN KEY (roles_id) REFERENCES public.roles(id);
